        ...
        <div className={`absolute inset-0 z-10 flex flex-col justify-center gap-2 px-6 py-6 sm:px-10 md:px-14 ${POSITION_CLASSES[position]}`}>
          ...
          {href && (
            <Link
              ...
              className="mt-1 inline-flex min-h-11 items-center gap-2 rounded-full bg-fcs-brand-strong px-5 text-sm font-bold text-white shadow-lg transition-all hover:-translate-y-0.5 hover:bg-[#9B5A64] focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2"
            >
              {ctaLabel}
