...
export function ProductDetailView({ slug }: ProductDetailViewProps) {
  const { goHome, goCatalog, goProduct, goCart, goCheckout, addToCart } =
    useStore()
    ...
    <div className="mx-auto max-w-7xl px-4 py-6 sm:px-6 lg:px-8">
      ...
      <div className="grid gap-8 lg:grid-cols-2 lg:gap-12">
        ...
        <div className="space-y-3">
          <div className="relative aspect-square overflow-hidden rounded-2xl border bg-secondary/20">
            {images[activeImage] ? (
              <img
        ...
        <div className="flex flex-col">
          ...
          {/* Description */}
          <div className="mt-5 prose prose-sm max-w-none text-foreground/85">
            ...
            <div className="flex items-start gap-2">
              ...
              <div>
                ...
                <p className="text-xs text-muted-foreground">
                  Kigali 1-2 days, provinces 3-5 days
                </p>
              </div>
            </div>
            <div className="flex items-start gap-2">
