...
const STORAGE_ATTEMPTS = "ubumwe-admin-attempts"
const STORAGE_LOCK = "ubumwe-admin-locked"
const STORAGE_REMEMBER = "ubumwe-admin-remember"
      ...
      <div className="w-full max-w-md">
        ...
        <div className="mt-6 text-center">
          ...
          <p className="mt-1 text-xs text-background/40">
            © {new Date().getFullYear()} Ubumwe Beauty Rwanda
          </p>
          <button
            onClick={goHome}
