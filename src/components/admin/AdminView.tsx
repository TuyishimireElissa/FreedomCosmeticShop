...
const ZeroResultSearches = dynamic(() => import('./ZeroResultSearches'), { loading: AdminSectionLoading })
const AdminProductManager = dynamic(() => import('./AdminProductManager').then((module) => module.AdminProductManager), { loading: AdminSectionLoading })
const BundleManager = dynamic(() => import('./BundleManager'), { loading: AdminSectionLoading })
const AdminCustomers = dynamic(() => import('./AdminCustomers').then((module) => module.AdminCustomers), { loading: AdminSectionLoading })
const AdminDeliveries = dynamic(() => import('./AdminDeliveries').then((module) => module.AdminDeliveries), { loading: AdminSectionLoading })
const AdminAnalytics = dynamic(() => import('./AdminAnalytics').then((module) => module.AdminAnalytics), { loading: AdminSectionLoading })
const AdminSettings = dynamic(() => import('./AdminSettings').then((module) => module.AdminSettings), { loading: AdminSectionLoading })
const RealTimeNotifications = dynamic(() => import('./RealTimeNotifications').then((module) => module.RealTimeNotifications))
const InvoicePrinter = dynamic(() => import('./InvoicePrinter').then((module) => module.InvoicePrinter))
const AdminSmsManager = dynamic(() => import('./AdminSmsManager').then((module) => module.AdminSmsManager), { loading: AdminSectionLoading })
const AdminPayments = dynamic(() => import('./AdminPayments').then((module) => module.AdminPayments), { loading: AdminSectionLoading })
const AdminMarketing = dynamic(() => import('./AdminMarketing').then((module) => module.AdminMarketing), { loading: AdminSectionLoading })
const AdminReports = dynamic(() => import('./AdminReports').then((module) => module.AdminReports), { loading: AdminSectionLoading })
const AdminStaff = dynamic(() => import('./AdminStaff').then((module) => module.AdminStaff), { loading: AdminSectionLoading })
const AdminSecurityDashboard = dynamic(() => import('./AdminSecurityDashboard').then((module) => module.AdminSecurityDashboard), { loading: AdminSectionLoading })
const AdminMobilePanel = dynamic(() => import('./AdminMobilePanel').then((module) => module.AdminMobilePanel))
const AdminWholesale = dynamic(() => import('./AdminWholesale').then((module) => module.AdminWholesale), { loading: AdminSectionLoading })
          ...
          {selectedOrder && (
            <>
              ...
              <div className="mt-4 space-y-5">
                ...
                <div className="space-y-3">
                  <div>
                    ...
                    >
                      ...
                      <SelectContent>
                        {[selectedOrder.status, ...(STATUS_NEXT[selectedOrder.status] || []).filter((status) => status !== 'CANCELLED' || canCancelOrders)].map((s) => (
                    ...
                    {STATUS_NEXT[selectedOrder.status]?.length > 0 && (
                      <div className="mt-2 flex flex-wrap gap-2">
                        {STATUS_NEXT[selectedOrder.status].filter((next) => next !== 'CANCELLED' || canCancelOrders).map((next) => (
                          <Button
                            key={next}
                            size="sm"
                  ...
                  <div>
                    ...
                    {canChangePayments && selectedOrder.paymentMethod === 'COD' ? <Select
                    ...
                    </Select> : <p className="text-xs text-muted-foreground">Online payment status is controlled by verified provider webhooks.</p>}
                  </div>
                </div>
                ...
                {canChangePayments && selectedOrder.paymentStatus === "PAID" && (
                  <Button
                    variant="outline"
                    size="sm"
