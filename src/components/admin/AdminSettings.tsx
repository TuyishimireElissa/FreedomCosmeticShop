...
export function AdminSettings() {
  const isSuperAdmin = useStore((state) => state.user?.role === 'SUPER_ADMIN')
  return (
    <div>
      <div className="mb-4">
      ...
      <Tabs defaultValue="logo">
        <TabsList className={`mb-4 grid w-full max-w-md ${isSuperAdmin ? 'grid-cols-5' : 'grid-cols-4'}`}>
          <TabsTrigger value="logo">Logo</TabsTrigger>
          <TabsTrigger value="coupons">Coupons</TabsTrigger>
          <TabsTrigger value="banners">Banners</TabsTrigger>
          <TabsTrigger value="delivery">Delivery</TabsTrigger>
          {isSuperAdmin && <TabsTrigger value="backup">Backup</TabsTrigger>}
        </TabsList>
