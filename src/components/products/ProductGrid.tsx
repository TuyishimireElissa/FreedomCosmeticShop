        ...
        return (
          <article key={product.id} className="group flex min-w-0 flex-col overflow-hidden rounded-2xl border border-gray-100 bg-white shadow-[0_5px_20px_rgba(26,26,26,0.05)] transition-all hover:-translate-y-1 hover:border-rose-100 hover:shadow-[0_16px_34px_rgba(183,110,121,0.14)]">
            ...
            <div className="flex flex-1 flex-col p-3 sm:p-4">
              ...
              <div className="mt-2 flex min-h-4 items-center gap-1">{product.reviewsCount > 0 ? <><Star className="h-3.5 w-3.5 fill-[#FFD700] text-[#FFD700]" /><span className="text-xs font-bold">{product.rating.toFixed(1)}</span><span className="text-[11px] text-gray-400">({product.reviewsCount})</span></> : <span className="text-[11px] font-medium text-gray-400">New · no reviews yet</span>}</div>
