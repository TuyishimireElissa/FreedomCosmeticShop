      ...
      >
        <div className="flex items-center gap-3 px-4 py-2.5">
          ...
          <button
            ...
            className="flex min-h-12 shrink-0 items-center justify-center gap-2 rounded-xl bg-fcs-brand px-6 text-sm font-bold text-white active:scale-[0.98] disabled:bg-gray-300"
          >
