...
export default function ProductReviews({ productId }: ProductReviewsProps) {
  ...
  if (loading) return <div className="py-10 text-center"><Loader2 className="mx-auto h-7 w-7 animate-spin text-fcs-brand-text" /><p className="mt-2 text-sm text-gray-500">{t('reviews.loading')}</p></div>
