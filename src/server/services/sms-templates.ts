 ...
 *
 * Brand: "Ubumwe Beauty" (used in all messages for consistency)
 *
...
export const SMS_TEMPLATES: Record<SmsTemplateKey, SmsTemplate> = {
  ORDER_PLACED: {
    ...
    en: "Thank you! Your order {{orderNumber}} has been received. We'll process it shortly. Ubumwe Beauty 📦",
    rw: "Murakoze! Itumwa ryawe {{orderNumber}} ryakirwa. Tuzoherekeza vuba. Ubumwe Beauty 📦",
  ...
  PAYMENT_CONFIRMED: {
    ...
    en: "Payment of {{amount}} RWF confirmed! Order {{orderNumber}} is being prepared. Ubumwe Beauty ✅",
    rw: "Kwishyura kwawe kwa {{amount}} RWF byagenze neza! Itumwa ryawe {{orderNumber}} riri mu nzira. Ubumwe Beauty ✅",
  ...
  ORDER_SHIPPED: {
    ...
    en: "Your order {{orderNumber}} is on the way! Rider: {{riderName}} - {{riderPhone}}. ETA: {{etaDays}} days. Ubumwe Beauty 🏍️",
    rw: "Ibicuruzwa byawe {{orderNumber}} byagiye! Muraza: {{riderName}} - {{riderPhone}}. Uzabibone mu minsi {{etaDays}}. Ubumwe Beauty 🏍️",
  ...
  ORDER_DELIVERED: {
    ...
    en: "Your order {{orderNumber}} has been delivered! Thank you for choosing Ubumwe Beauty. Review: {{reviewLink}} 🌟",
    rw: "Itumwa ryawe {{orderNumber}} ryarafitiwe! Murakoze guhitamo Ubumwe Beauty. Tanga igitekerezo: {{reviewLink}} 🌟",
  ...
  LOW_STOCK: {
    ...
    en: "ALERT: {{productName}} has only {{stockCount}} items left! Restock soon. Ubumwe Beauty Admin",
    rw: "IMENYESHA: {{productName}} isigaye {{stockCount}} gusa! Ongera wugure. Ubumwe Beauty Admin",
  ...
  OTP: {
    ...
    en: "Ubumwe Beauty: Your verification code is {{code}}. Valid for 5 minutes. Do not share it with anyone.",
    rw: "Ubumwe Beauty: Kod yawe yo kwemeza ni {{code}}. Irahoraho iminota 5. Ntuyisangire n'umwe.",
    variables: ["code"],
    critical: true,
  },
  ...
  ABANDONED_CART: {
    ...
    en: "You left {{itemCount}} item(s) in your cart! Complete your order now: {{cartLink}} Ubumwe Beauty 🛒",
    rw: "Mutasize ibintu {{itemCount}} mu gitebo cyanyu! Gura none: {{cartLink}} Ubumwe Beauty 🛒",
  ...
  WELCOME: {
    ...
    en: "Welcome to Ubumwe Beauty, {{customerName}}! Enjoy 10% off your first order with code WELCOME10. 🌸",
    rw: "Murakaza neza kuri Ubumwe Beauty, {{customerName}}! Hema 10% ku gitebo cyawe na kode WELCOME10. 🌸",
  ...
  PROMOTIONAL: {
    ...
    en: "{{message}}{{code ? ' Use code: ' + code : ''}} Ubumwe Beauty 🌸",
    rw: "{{message}}{{code ? ' Koresha kode: ' + code : ''}} Ubumwe Beauty 🌸",
