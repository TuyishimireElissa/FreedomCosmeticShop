        ...
        <div className="w-full max-w-md">
          ...
          <div className="rounded-xl border border-[#EEEEEE] bg-white p-6 shadow-[0_1px_3px_rgba(0,0,0,0.04)] sm:p-8">
            ...
            <form onSubmit={submit} className="mt-6 space-y-4">
              ...
              />
              <button type="submit" disabled={loading} className="flex min-h-12 w-full items-center justify-center gap-2 rounded-[10px] bg-fcs-brand text-base font-black text-white  hover:bg-[#9B5A64] disabled:opacity-50">{loading ? <><Loader2 className="h-4 w-4 animate-spin" />{t('auth.logging_in')}</> : <>{t('auth.login_button')} <ArrowRight className="h-4 w-4" /></>}</button>
            </form>
