 ...
 *   - search: free-text search on name/brand/description (optional)
 ...
 *
 * Returns a list of products with their category.
 */
...
export async function GET(req: Request) {
  try {
    ...
    // Parse image JSON for each product (SQLite stores as string)
