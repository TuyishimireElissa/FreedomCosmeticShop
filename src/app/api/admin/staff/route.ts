...
const DEFAULT_PERMISSIONS: Record<string, string[]> = {
  ADMIN: ['orders.read','orders.update','orders.refund','products.read','products.update','products.crud','customers.read','customers.update','customers.crud','deliveries.read','deliveries.update','deliveries.crud','coupons.read','coupons.update','coupons.crud','banners.read','banners.update','banners.crud','content.read','content.update','wholesale.read','wholesale.update','reviews.moderate','sms.send','sms.schedule','analytics.read','reports.read','staff.manage','settings.update'],
  MANAGER: ['orders.read','orders.update','products.read','products.update','customers.read','customers.update','deliveries.read','deliveries.update','coupons.read','coupons.update','banners.read','banners.update','content.read','content.update','wholesale.read','wholesale.update','reviews.moderate','sms.send','analytics.read','reports.read'],
