...
const previews = read('src/components/blog/BlogListingClient.tsx')
...
describe('Kinyarwanda blog starters', () => {
  ...
  it('renders article text and image alternatives in the selected customer language', () => {
    ...
    expect(previews).toContain("language === 'rw' && post.titleRw")
    expect(previews).toContain("language === 'rw' && post.excerptRw")
